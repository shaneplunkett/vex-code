...
export const ChangedFilesCard = memo(function ChangedFilesCard(props: {
  ...
  return (
    <div
      className="@container/changed-files mt-4 rounded-2xl border border-input bg-background p-2 shadow-xs/5 not-dark:bg-clip-padding"
    ...
    >
      <div
        ...
        className={cn(
          ...
          expanded && "sticky top-2 z-10 mb-2 bg-background",
        )}
      >
        <button
          type="button"
